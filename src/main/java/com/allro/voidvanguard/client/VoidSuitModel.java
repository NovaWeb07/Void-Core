...
@OnlyIn(Dist.CLIENT)
public class VoidSuitModel extends HumanoidModel<LivingEntity> {
    ...
    public VoidSuitModel(ModelPart root) {
        super(root);
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        CubeDeformation gap = new CubeDeformation(0.08F);
        ...
        head.addOrReplaceChild("helmet_front",
                CubeListBuilder.create().addBox(-4.5F, -6.0F, -4.5F, 9.0F, 7.0F, 1.0F, gap),
                PartPose.ZERO);
        ...
        partdefinition.addOrReplaceChild("right_arm", CubeListBuilder.create()
                .addBox(-3.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, gap), PartPose.offset(-5.0F, 2.0F, 0.0F));

        partdefinition.addOrReplaceChild("left_arm", CubeListBuilder.create()
                .addBox(-1.5F, -2.5F, -2.5F, 5.0F, 13.0F, 5.0F, gap), PartPose.offset(5.0F, 2.0F, 0.0F));
        ...
        rightLeg.addOrReplaceChild("lower", CubeListBuilder.create()
                .addBox(-2.5F, 6.0F, -2.5F, 5.0F, 7.0F, 5.0F, gap), PartPose.ZERO);
