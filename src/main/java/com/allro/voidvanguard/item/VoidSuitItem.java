...
import com.allro.voidvanguard.client.VoidSuitModel;
...
public class VoidSuitItem extends ArmorItem {

    public VoidSuitItem(Type type, Properties properties) {
    ...
    public void initializeClient(Consumer<IClientItemExtensions> consumer) {
        consumer.accept(new IClientItemExtensions() {
            private VoidSuitModel model;

            @Override
            public HumanoidModel<?> getHumanoidArmorModel(LivingEntity entityLiving, ItemStack itemStack,
                    EquipmentSlot armorSlot, HumanoidModel<?> _default) {
                if (this.model == null) {
                    this.model = new VoidSuitModel(Minecraft.getInstance().getEntityModels().bakeLayer(ClientEvents.VOID_SUIT));
                }
